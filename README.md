...
![Data Visualization](https://img.shields.io/badge/Data_Visualization-673AB7?style=for-the-badge&logo=plotly&logoColor=white)
...
![EDA](https://img.shields.io/badge/EDA-4CAF50?style=for-the-badge&logo=python&logoColor=white)
![Data Visualization](https://img.shields.io/badge/Data_Visualization-673AB7?style=for-the-badge&logo=plotly&logoColor=white)
...
![RAG](https://img.shields.io/badge/RAG_(Retrieval_Augmented_Generation)-5C2D91?style=for-the-badge&logo=python&logoColor=white)
...
![Power_Apps](https://img.shields.io/badge/Power_Apps-742774?style=for-the-badge&logo=powerapps&logoColor=white)
...
Automação inteligente para agendamento de eventos com integração ao Google Calendar, utilizando agentes de IA e bots no Telegram.  
🔗 Repositório: https://github.com/Alexsidius/N8n-Bot-telegram-gemini-agent-calendario

---

### 📊 Projetos de Análise de Dados
Repositórios com estudos e práticas em Python, Pandas e NumPy voltados para análise e manipulação de dados.

🔗 Veja os repositórios no meu GitHub
...
Atuar na área de **Análise de dados, Ciência de Dados, Inteligência Artificial ou Automação**, aplicar soluções baseadas em dados que gerem impacto real nos negócios e apoiem decisões estratégicas.
