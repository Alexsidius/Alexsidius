...
Atuo há mais de 10 anos como Analista de Manutenção Industrial e venho aplicando tecnologia, dados e automação para resolver problemas reais e apoiar a tomada de decisão. Busco migrar profissionalmente para a área de **Análise de Dados, Ciência de Dados e IA Generativa**.
...
![Model Evaluation](https://img.shields.io/badge/Model_Evaluation-009688?style=for-the-badge&logo=python&logoColor=white)
...
![Prompt Engineering](https://img.shields.io/badge/Prompt_Engineering-7B2CBF?style=for-the-badge&logo=artificial-intelligence&logoColor=white)
...
Atuar na área de **Análise de Dados, Ciência de Dados, Inteligência Artificial ou Automação**, aplicando soluções baseadas em dados que gerem impacto real nos negócios e apoiem decisões estratégicas.
